...
const TransactionPool=require('./wallet/transaction-pool.test');
const Wallet = require('./wallet');

const pubnub=new Pubnub({blockchain});
const DEFAULT_PORT=3000;
const ROOT_NODE_ADDRESS = `http://localhost:$(DEFAULT_PORT}`;
setTimeout(()=>pubnub.broadcastChain(),1000);
const app = express();
...
app.post('/api/mine', (req, res) => {
    ...
    pubnub.broadcastChain();
    res.redirect('/api/blocks'); // Corrected with quotes
});
